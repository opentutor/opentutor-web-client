...
import { Grid, Typography, useMediaQuery, Paper, styled } from "@mui/material";
...
const SurveySays = (props: {
  ...
  const { classes: stylesDesktop } = surveySaysStylesDesktop();
  const { classes: stylesMobile } = surveySaysStylesMobile();
