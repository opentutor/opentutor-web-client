...
TEST_E2E_DOCKER_IMAGE_SNAPSHOTS_DIFF_OUTPUT?=$(TEST_E2E_DOCKER_IMAGE_SNAPSHOTS_PATH)/__diff_output__
...
.PHONY: test-e2e-exec
test-e2e-exec:
	$(TEST_E2E_DOCKER_COMPOSE) exec -T cypress npx cypress run --env "CYPRESS_SNAPSHOT_DIFF_DIR=$(TEST_E2E_DOCKER_IMAGE_SNAPSHOTS_DIFF_OUTPUT)"
